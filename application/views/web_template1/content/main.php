<main>
    ...
    <section>
        <div class="collection-wrapper-head">
            <div class="title-home">
                <h1 class="text-title-home">Gife Commerce Collection</h1>
