            ...
            <div class="row">
                <div class="small-12 medium-8 columns">
                    <div class="login-wrapper"> <?php
                        ...
                        <?php }else{?>
                            <h4>Choose delivery (the shop will choose to deliver)</h4>
                        <?php }?>
                            <div class="row">
                ...
                <?php }else{?>
                    <div class="row">
                                <div class="small-4 medium-3 columns">
                                    <label for="OD_Name" class="middle label-login">Name-Lastname: </label>
                                </div>
                                <div class="small-8 medium-9 columns">
                                    <input type="text" id="OD_Name" name="OD_Name" placeholder="Name-Lastname" required value="<?php echo get_session('OD_Name'); ?>">
                                    <span class="form-error"><h5>Please enter your first and last name</h5></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="small-4 medium-3 columns">
                                    <label for="OD_Tel" class="middle label-login">Phone: </label>
                                </div>
                                <div class="small-8 medium-9 columns">
                                    <input type="text" id="OD_Tel" name="OD_Tel" placeholder="Phone" required value="<?php echo get_session('OD_Tel'); ?>">
                                    <span class="form-error"><h5>Please enter phone number</h5></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="small-4 medium-3 columns">
                                    <label for="OD_Email" class="middle label-login">E-Mail: </label>
                                </div>
                                <div class="small-8 medium-9 columns">
                                    <input type="text" id="OD_Email" name="OD_Email" placeholder="E-Mail" required value="<?php echo get_session('OD_Email'); ?>">
                            ...
                            <div class="row">
                                <div class="small-4 medium-3 columns">
                                    <label for="OD_LaneRoad" class="middle label-login">Alley: </label>
                                </div>
                                <div class="small-8 medium-9 columns">
                                    <input type="text" id="OD_LaneRoad" name="OD_LaneRoad" placeholder="Alley" value="<?php echo get_session('OD_LaneRoad'); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="small-4 medium-3 columns">
                            ...
                            <div class="row">
                                <div class="small-4 medium-3 columns">
                                    <label for="Amphur_ID" class="middle label-login">district: </label>
                                </div>
                                <div class="small-8 medium-9 columns">
                                    <select id="Amphur_ID" name="Amphur_ID" onchange="ajaxRequest('<?php echo base_url('main/locations'); ?>', 'districts', 'Amphur_ID', this.value, 'District_ID', 'District_Name', '#District_ID', 'select')" required> <?php
                                        foreach ($amphures as $key => $value) { ?>
                                    ...
                                    <span class="form-error"><h5>Please select a District</h5></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="small-4 medium-3 columns">
                                    <label for="District_ID" class="middle label-login">sub-district: </label>
                                </div>
                                <div class="small-8 medium-9 columns">
                                    <select id="District_ID" name="District_ID" onchange="ajaxRequest('<?php echo base_url('main/locations'); ?>', 'zipcodes', 'District_ID', this.value, 'Zipcode_ID', 'Zipcode_Code', '.zipcodes', 'input')" required> <?php
                                        foreach ($districts as $key => $value) { ?>
                                    ...
                                    <span class="form-error"><h5>Please select a Subdistrict</h5></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="small-4 medium-3 columns">
