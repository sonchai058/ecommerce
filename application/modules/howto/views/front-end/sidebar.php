<div class="small-12 medium-3 columns">
	...
	<?php }else{?>
		...
		<li><a href="<?php echo base_url('howto/supplying'); ?>" 	class="categoires-title <?php if (uri_seg(1) === 'howto' &&  uri_seg(2) === 'supplying'		) echo 'active'; ?>">How to buy</a></li>
		<li><a href="<?php echo base_url('howto'); ?>" 				class="categoires-title <?php if (uri_seg(1) === 'howto' && !uri_seg(2)						) echo 'active'; ?>">payment method</a></li>
		<li><a href="<?php echo base_url('howto/verify'); ?>" 		class="categoires-title <?php if (uri_seg(1) === 'howto' &&  uri_seg(2) === 'verify'		) echo 'active'; ?>">Order Status Check</a></li>
		<!-- <li><a href="<?php echo base_url('howto/ordercancel'); ?>" 	class="categoires-title <?php if (uri_seg(1) === 'howto' &&  uri_seg(2) === 'ordercancel'	) echo 'active'; ?>">cancel order</a></li> -->
	<?php }?>
	</ul>
</div>