		...
		<div class="row">
			...
			<?php if(@$_GET['language']==''|| @$_GET['language']=='thai'){?>
				...
				<div class="transport-wrapper">
					...
					<br>
					<p>แต่ท่านสามารถตรวจสอบสถานะรายการสั่งซื้อของท่านได้ที่เครื่องมือติดตามสถานะคำสั่งซื้อของเรา <a href="<?php echo base_url('member/transfercustom'); ?>" class="link">คลิกที่นี่</a> ระบบของ Tanishadoor จะปรับปรุงข้อมูลเป็นรายวัน เพื่อที่จะให้บริการตรวจสอบสถานะคำสั่งซื้อที่ดีที่สุดแก่ท่าน</p>
					<br>
...
<?php }else{?>
				...
				<div class="transport-wrapper">
					...
					<ol class="service-ol" style="margin-left: 40px;">
						<li>go to <a href="<?php echo base_url('member/transfercustom'); ?>" class="link">transfer money</a></li>
					...
					<br>
					<p>But you can check the status of your order on our order tracking tool. <a href="<?php echo base_url('member/transfercustom'); ?>" class="link">click here</a> Tanishadoor's system will update the information daily. In order to provide you with the best order tracking service</p>
					<br>
					<p>If after 1 business day you still cannot use the parcel number. please contact us <a href="<?php echo base_url('contactus'); ?>" class="link">click here</a> We will help you immediately.</p>
